...
| T4 の再測定 (標準 / 本気-累積) | ⬜ Phase 0 で実施 (前回のプロセスは結果を残さず終了) |
...
| 0-3 | **T4 再測定** (標準 / 本気-累積) | F3 の空欄を埋める | ⬜ | 崩れるなら多相の扱いが優先課題に繰り上がる |
