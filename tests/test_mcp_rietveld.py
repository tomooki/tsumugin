...
def test_stability_spec_reaches_the_real_runner(monkeypatch):
    ...
    def _spy(seed, max_cyc=12, stability=None, backend="gsasii", **_kw):
...
def test_stability_spec_defaults_to_the_no_op_options(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda seed, max_cyc=12, stability=None, backend="gsasii", **_kw: seen.update(stability=stability) or _stub_runner,
    )
